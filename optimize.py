...
def train_and_optimize(hyper_config):
    ...
    res = -train_Q(a,g,epsilon,N=4,N_episodes=3000)
    return res
...
res = gp_minimize(train_and_optimize, hyper_config,n_calls=400,verbose=True,n_random_starts=100)

with open('results_3000_episodes_N_4_500_new_rewards.txt', 'w') as wf:
    wf.write(str(res))
print(res)
